    ...
    public class HandTests
    {
        ...
        public void TestCalculateHand()
        {
            List<Card> twoCards = new List<Card>
                {new Card(Card.Value.Two, Card.Suit.Clubs), new Card(Card.Value.Four, Card.Suit.Hearts)};
            Hand hand = new Hand(twoCards);
            Assert.Equal(6, hand.CalculateHandSum());

            List<Card> nonNumberCards = new List<Card>
                {new Card(Card.Value.Jack, Card.Suit.Clubs), new Card(Card.Value.Two, Card.Suit.Hearts)};
        ...
        {
            List<Card> aceAsOne = new List<Card>
            {
            ...
            List<Card> aceAsEleven = new List<Card>
                {new Card(Card.Value.Three, Card.Suit.Clubs), new Card(Card.Value.Ace, Card.Suit.Spades)};
